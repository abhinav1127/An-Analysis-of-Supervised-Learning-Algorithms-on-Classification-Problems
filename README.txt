...
All of the data and files are included in the same folder. Each python file represents an algorithm paired with a particular dataset. The shorthand stands for:
