...
# plt.title('Layers')
# plt.savefig("Layers_NNPD.png")
#
# idealLayers = CV_results.index(max(CV_results))
# idealLayers += 1
...
plt.savefig("NodesinLayers_NNPD.png")
...
plot_confusion_matrix(cnf_matrix, classes=[0, 1],
                      title='Confusion matrix')
plt.savefig("CFMatrix_NNPD.png")

plt.figure()
plot_learning_curve(mlp, "Learning Curve", X_train, y_train, cv=3)
plt.savefig("LearningCurveNNPD.png")
