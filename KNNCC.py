...
plt.draw()
plt.savefig("NeighborsCC.png")

idealNeighbors = recall_CV_results.index(max(recall_CV_results))
idealNeighbors += 1
...
plot_confusion_matrix(cnf_matrix, classes=[0, 1],
                      title='Confusion matrix')
plt.savefig("CFMatrix_KNNCC.png")

plt.figure()
plot_learning_curve(knn, "Learning Curve", X_train, y_train, cv=3)
plt.savefig("LearningCurveKNNCC.png")